...
<p align="center">
  <img src="images/output.png" alt="output_example"/>
</p>

## Motivation
I originally managed my investments and rebalancing in a spreadsheet. I ported the logic to a CLI tool to achieve:
...
To use your own portfolio, modify the existing json file, or create your own, as follows:
